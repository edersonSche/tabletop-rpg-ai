...
const ITEMS: Record<string, ItemDefinition> = {
  ...
  shortsword: {
    type: 'weapon',
    slot: 'hand',
    modifiers: [{ stat: 'damage', value: 2, operation: 'add' }],
    translations: {
  ...
  battleaxe: {
    type: 'weapon',
    slot: 'hand',
    modifiers: [{ stat: 'damage', value: 3, operation: 'add' }],
    translations: {
  ...
  leather_armor: {
    type: 'armor',
    slot: 'body',
    modifiers: [{ stat: 'ac', value: 1, operation: 'add', dexCap: 999 }],
    translations: {
  ...
  chain_shirt: {
    type: 'armor',
    slot: 'body',
    modifiers: [{ stat: 'ac', value: 2, operation: 'add', dexCap: 2 }],
    translations: {
  ...
  shield: {
    type: 'armor',
    slot: 'hand',
    modifiers: [{ stat: 'ac', value: 2, operation: 'add' }],
    translations: {
  ...
  bandage: {
    type: 'misc',
    effects: [{ type: 'heal_hp', formula: '1d4' }],
    translations: {
  ...
  medkit: {
    type: 'potion',
    effects: [{ type: 'heal_hp', formula: '2d4+4' }],
    translations: {
