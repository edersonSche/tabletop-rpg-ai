...
- `game/` — Decomposed into 6 focused services:
  ...
  - `GameGateway` (`game.gateway.ts`) — WebSocket handlers (action/roll/start/typing/get_state/room:join/allocate_attributes/equip/unequip/use_item/use_antidote/initiate_trade/buy_item/sell_item/end_trade), dispatches to appropriate services
