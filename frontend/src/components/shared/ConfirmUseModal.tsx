...
export function ConfirmUseModal({ item, onUse, onClose }: ConfirmUseModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/85" onClick={onClose}>
      <div className="pixel-border-ornate bg-panel-950 max-w-xs w-full mx-4 p-4" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="space-y-1.5">
          <button onClick={() => { onUse(); onClose(); }} className="w-full btn-rpg">
            USE
          </button>
