...
export default {
  ...
  theme: {
    extend: {
      ...
      keyframes: {
        'crystal-pulse': {
          '0%, 100%': { opacity: '0.6', boxShadow: '0 0 8px rgba(0, 217, 255, 0.2)' },
      ...
      backgroundImage: {
        'gradient-navy': 'linear-gradient(180deg, #050B1B 0%, #071326 50%, #0A1629 100%)',
        'gradient-navy-radial': 'radial-gradient(ellipse at center, #0B1729 0%, #050B1B 100%)',
        'gradient-gold-shimmer': 'linear-gradient(90deg, transparent, rgba(197, 138, 43, 0.15), transparent)',
      },
    },
  },
  plugins: [],
